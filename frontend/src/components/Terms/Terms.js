      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          ...
          <p className="text-gray-700">
            Welcome to PriHub. These Terms of Service govern your use of our cognitive disability support platform 
            and services provided by Civora Nexus Pvt. Ltd. By accessing or using PriHub, you agree to be bound by these Terms.
          </p>
        </div>
