...
import { ExternalLink, Wifi, Users, Star, TrendingUp, Clock, ArrowRight, Search, Filter, Cpu, Home, Car, Factory, Heart, Shield, Zap, Target, Award, Download, FileText, Printer } from 'lucide-react';

const IoTSolutionProviders = () => {
  ...
  const generateCertificateContent = (partner) => {
    ...
    const certificateNumber = `CERT-IOT-${partner.name.replace(/\s+/g, '-').toUpperCase()}-${Date.now().toString().slice(-6)}`;
...
<body>
    <div class="certificate">
        ...
        <div class="header">
            ...
            <p class="subtitle">IoT Innovation Alliance</p>
        </div>
        ...
        <div class="content">
            ...
            <p class="body-text">
                In recognition of their outstanding contributions to IoT innovation 
                and commitment to advancing connected solutions for individuals with disabilities.
            </p>
            ...
            <div class="partnership-details">
                ...
                <div class="details-grid">
                    ...
                    <div class="detail-item">
                        ...
                        <div class="detail-value">${partner.devices || 'IoT Devices'}</div>
                    </div>
                    <div class="detail-item">
                        <div class="detail-label">Connectivity:</div>
                        <div class="detail-value">${partner.connectivity || 'Smart Solutions'}</div>
                    </div>
                    <div class="detail-item">
            ...
            <p class="body-text">
                This partnership signifies a shared commitment to IoT innovation, smart connectivity, and 
  ...
  const partnerData = {
    ...
    rating: "4.7",
    years: "7+",
    growthMetric: "IoT Innovation",
    image: "/IoTSolutionProviders.webp",
    totalPrograms: "500+",
    beneficiaries: "5M+",
    volunteers: "200K+",
    countries: "150+"
  ...
  const categories = [
    { id: 'all', name: 'All Categories', icon: Wifi },
    { id: 'smart', name: 'Smart Home', icon: Home },
    { id: 'automotive', name: 'Automotive', icon: Car },
    { id: 'industrial', name: 'Industrial', icon: Factory },
    { id: 'healthcare', name: 'Healthcare', icon: Heart },
    { id: 'security', name: 'Security', icon: Shield },
    { id: 'platforms', name: 'Platforms', icon: Cpu }
  ];

  const directLinks = [
    { name: "Amazon Web Services IoT", url: "https://aws.amazon.com/iot", description: "Cloud IoT platform and services", category: 'platforms', rating: 4.8, devices: '10M+', founded: '2006' },
    { name: "Microsoft Azure IoT", url: "https://azure.microsoft.com/iot", description: "Enterprise IoT solutions", category: 'platforms', rating: 4.7, devices: '8M+', founded: '2010' },
    { name: "Google Cloud IoT", url: "https://cloud.google.com/iot", description: "IoT platform and analytics", category: 'platforms', rating: 4.6, devices: '5M+', founded: '2008' },
    { name: "IBM Watson IoT", url: "https://ibm.com/iot", description: "Industrial IoT and AI solutions", category: 'industrial', rating: 4.5, devices: '3M+', founded: '2015' },
    { name: "Siemens IoT", url: "https://siemens.com/iot", description: "Industrial automation IoT", category: 'industrial', rating: 4.6, devices: '2M+', founded: '1847' },
    { name: "General Electric IoT", url: "https://ge.com/digital", description: "Industrial IoT solutions", category: 'industrial', rating: 4.4, devices: '1M+', founded: '1892' },
    { name: "Philips Hue", url: "https://philips-hue.com", description: "Smart lighting solutions", category: 'smart', rating: 4.5, devices: '50M+', founded: '2012' },
    { name: "Nest", url: "https://nest.com", description: "Smart home devices", category: 'smart', rating: 4.6, devices: '100M+', founded: '2010' },
    { name: "SmartThings", url: "https://smartthings.com", description: "Smart home platform", category: 'smart', rating: 4.4, devices: '20M+', founded: '2012' },
    { name: "Ring", url: "https://ring.com", description: "Smart security devices", category: 'security', rating: 4.5, devices: '10M+', founded: '2012' },
    { name: "Arlo", url: "https://arlo.com", description: "Smart security cameras", category: 'security', rating: 4.3, devices: '5M+', founded: '2014' },
    { name: "August Home", url: "https://august.com", description: "Smart locks and security", category: 'security', rating: 4.2, devices: '2M+', founded: '2013' },
    { name: "Fitbit", url: "https://fitbit.com", description: "Health and fitness IoT", category: 'healthcare', rating: 4.6, devices: '100M+', founded: '2007' },
    { name: "Apple HealthKit", url: "https://developer.apple.com/healthkit", description: "Health monitoring devices", category: 'healthcare', rating: 4.7, devices: '500M+', founded: '2014' },
    { name: "Medtronic IoT", url: "https://medtronic.com/iot", description: "Medical device connectivity", category: 'healthcare', rating: 4.5, devices: '10M+', founded: '1949' },
    { name: "Tesla", url: "https://tesla.com", description: "Electric vehicles and IoT", category: 'automotive', rating: 4.8, devices: '5M+', founded: '2003' },
    { name: "Waymo", url: "https://waymo.com", description: "Autonomous vehicle IoT", category: 'automotive', rating: 4.6, devices: '1M+', founded: '2009' },
    { name: "Cruise", url: "https://getcruise.com", description: "Self-driving car technology", category: 'automotive', rating: 4.5, devices: '500K+', founded: '2013' },
    { name: "NVIDIA IoT", url: "https://nvidia.com/iot", description: "Edge AI and IoT computing", category: 'platforms', rating: 4.7, devices: '2M+', founded: '1993' },
    { name: "Intel IoT", url: "https://intel.com/iot", description: "IoT hardware and software", category: 'platforms', rating: 4.4, devices: '1M+', founded: '1968' }
  ];
  ...
  const sortedLinks = [...filteredLinks].sort((a, b) => {
    ...
    if (sortBy === 'devices') return b.devices.localeCompare(a.devices);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-4">
            <span style={{ color: '#16808D' }}>IoT Solution</span> Providers
          </h1>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto mb-6">
            Leading IoT solution providers offering smart home, automotive, industrial, healthcare, and security solutions through advanced Internet of Things technologies.
          </p>
          <div className="flex flex-wrap justify-center gap-3">
            <span className="px-3 py-1 bg-teal-100 text-teal-700 rounded-full text-sm font-medium">Smart Home</span>
            <span className="px-3 py-1 bg-cyan-100 text-cyan-700 rounded-full text-sm font-medium">Automotive Solutions</span>
            <span className="px-3 py-1 bg-green-100 text-green-700 rounded-full text-sm font-medium">Industrial IoT</span>
            <span className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium">Healthcare IoT</span>
            <span className="px-3 py-1 bg-orange-100 text-orange-700 rounded-full text-sm font-medium">Security Platforms</span>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-12 border border-gray-100">
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
            <div className="bg-gradient-to-br from-teal-50 to-teal-100 rounded-xl p-4 text-center">
              ...
              <p className="text-xs text-teal-600">Providers</p>
            </div>
            <div className="bg-gradient-to-br from-cyan-50 to-cyan-100 rounded-xl p-4 text-center">
              ...
              <p className="text-xs text-cyan-600">Device Connectivity</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-xl p-4 text-center">
              ...
              <h3 className="text-xl font-bold text-indigo-700 mb-1">{partnerData.totalPrograms}</h3>
              <p className="text-xs text-indigo-600">IoT Solutions</p>
            </div>
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-4 text-center">
              ...
              <p className="text-xs text-purple-600">Connected Devices</p>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
          ...
          <div className="flex flex-col lg:flex-row gap-4">
            <div className="flex-1 relative">
              ...
              <input
                type="text"
                placeholder="Search IoT solution providers..."
                value={searchTerm}
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-2 px-4 py-2 bg-teal-50 rounded-lg">
                ...
                <span className="text-teal-700 font-medium">{filteredLinks.length} providers found</span>
              </div>
            </div>
          </div>
        </div>
                ...
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className="flex items-center justify-center relative">
                    <div className="w-16 h-16 bg-gradient-to-br from-teal-100 to-cyan-100 rounded-full shadow-sm border border-teal-200 overflow-hidden">
                      <img 
                        src={`https://source.unsplash.com/400x400/?${encodeURIComponent(link.name.toLowerCase().replace(/\s+/g, '+'))},logo,official,iot`}
                        alt={link.name}
                ...
                <div className="space-y-3 mb-4 mt-auto">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center text-sm">
                      ...
                      <div>
                        <span className="font-semibold text-gray-900">{link.devices}</span>
                        <span className="text-xs text-gray-500 ml-1">devices</span>
                      </div>
                    </div>
                    <div className="px-3 py-1 bg-gradient-to-r from-teal-100 to-cyan-100 text-teal-700 text-xs rounded-full font-semibold border border-teal-200">
                      {categories.find(cat => cat.id === link.category)?.name || 'IoT'}
                    </div>
                  </div>
...
export default IoTSolutionProviders;
