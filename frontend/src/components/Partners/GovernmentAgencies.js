...
import { ExternalLink, Building, Users, Star, TrendingUp, Clock, ArrowRight, Search, Filter, Zap, Award, Shield, Download, FileText, Printer, Heart, Target, Gavel, Flag } from 'lucide-react';
...
const GovernmentAgencies = () => {
  ...
  const generateCertificateContent = (partner) => {
    ...
    const certificateNumber = `CERT-GA-${partner.name.replace(/\s+/g, '-').toUpperCase()}-${Date.now().toString().slice(-6)}`;
...
<body>
    <div class="certificate">
        ...
        <div class="header">
            ...
            <p class="subtitle">Government Services Alliance</p>
        </div>
        ...
        <div class="content">
            ...
            <p class="body-text">
                In recognition of their outstanding contributions to government services innovation 
                and commitment to advancing accessible public services for individuals with disabilities.
            </p>
            ...
            <div class="partnership-details">
                ...
                <div class="details-grid">
                    ...
                    <div class="detail-item">
                        ...
                        <div class="detail-value">${partner.services || 'Public Services'}</div>
                    </div>
                    <div class="detail-item">
                        <div class="detail-label">Jurisdiction:</div>
                        <div class="detail-value">${partner.jurisdiction || 'National/Regional'}</div>
                    </div>
                    <div class="detail-item">
            ...
            <p class="body-text">
                This partnership signifies a shared commitment to public service, civic engagement, and 
  ...
  const partnerData = {
    ...
    rating: "4.5",
    years: "15+",
    growthMetric: "Public Service",
    image: "/GovernmentAgencies.webp",
    totalPrograms: "1K+",
    beneficiaries: "100M+",
    volunteers: "50K+",
    countries: "150+"
  ...
  const categories = [
    ...
    { id: 'federal', name: 'Federal', icon: Flag },
    { id: 'state', name: 'State', icon: Shield },
    { id: 'local', name: 'Local', icon: Gavel },
    { id: 'health', name: 'Health', icon: Award },
    { id: 'education', name: 'Education', icon: Target }
  ];

  const directLinks = [
    { name: "Department of Health", url: "https://hhs.gov", description: "Health and human services", category: 'health', rating: 4.6, services: '100+', founded: '1979' },
    { name: "Department of Education", url: "https://ed.gov", description: "Education policy and programs", category: 'education', rating: 4.4, services: '80+', founded: '1980' },
    { name: "Social Security Administration", url: "https://ssa.gov", description: "Social security benefits", category: 'federal', rating: 4.5, services: '50+', founded: '1935' },
    { name: "Department of Labor", url: "https://dol.gov", description: "Worker protection and benefits", category: 'federal', rating: 4.3, services: '40+', founded: '1913' },
    { name: "Department of Justice", url: "https://justice.gov", description: "Law enforcement and justice", category: 'federal', rating: 4.4, services: '60+', founded: '1870' },
    { name: "Department of Transportation", url: "https://transportation.gov", description: "Transportation services", category: 'federal', rating: 4.2, services: '30+', founded: '1966' },
    { name: "Department of Housing", url: "https://hud.gov", description: "Housing and urban development", category: 'federal', rating: 4.3, services: '25+', founded: '1965' },
    { name: "Department of Energy", url: "https://energy.gov", description: "Energy policy and research", category: 'federal', rating: 4.5, services: '20+', founded: '1977' },
    { name: "Environmental Protection Agency", url: "https://epa.gov", description: "Environmental protection", category: 'federal', rating: 4.6, services: '35+', founded: '1970' },
    { name: "Department of Agriculture", url: "https://usda.gov", description: "Agriculture and food services", category: 'federal', rating: 4.4, services: '45+', founded: '1862' },
    { name: "Department of Commerce", url: "https://commerce.gov", description: "Economic growth and trade", category: 'federal', rating: 4.3, services: '15+', founded: '1903' },
    { name: "Department of Treasury", url: "https://treasury.gov", description: "Economic and financial services", category: 'federal', rating: 4.5, services: '20+', founded: '1789' },
    { name: "Department of Defense", url: "https://defense.gov", description: "National defense services", category: 'federal', rating: 4.7, services: '100+', founded: '1947' },
    { name: "Department of Veterans Affairs", url: "https://va.gov", description: "Veterans services and benefits", category: 'health', rating: 4.8, services: '70+', founded: '1930' },
    { name: "Department of Interior", url: "https://doi.gov", description: "Natural resources and land", category: 'federal', rating: 4.4, services: '40+', founded: '1849' },
    { name: "Department of State", url: "https://state.gov", description: "Foreign affairs and diplomacy", category: 'federal', rating: 4.6, services: '30+', founded: '1789' },
    { name: "NASA", url: "https://nasa.gov", description: "Space exploration and research", category: 'federal', rating: 4.9, services: '25+', founded: '1958' },
    { name: "FEMA", url: "https://fema.gov", description: "Emergency management", category: 'federal', rating: 4.5, services: '15+', founded: '1979' },
    { name: "CDC", url: "https://cdc.gov", description: "Disease control and prevention", category: 'health', rating: 4.8, services: '50+', founded: '1946' },
    { name: "FBI", url: "https://fbi.gov", description: "Federal investigation services", category: 'federal', rating: 4.7, services: '35+', founded: '1908' }
  ];
  ...
  const sortedLinks = [...filteredLinks].sort((a, b) => {
    ...
    if (sortBy === 'services') return b.services.localeCompare(a.services);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-4">
            <span style={{ color: '#16808D' }}>Government</span> Agencies
          </h1>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto mb-6">
            Leading government agencies providing essential public services, regulatory oversight, and citizen support through comprehensive programs and administrative functions.
          </p>
          <div className="flex flex-wrap justify-center gap-3">
            <span className="px-3 py-1 bg-indigo-100 text-indigo-700 rounded-full text-sm font-medium">Public Services</span>
            <span className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium">Regulatory Oversight</span>
            <span className="px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-sm font-medium">Citizen Support</span>
            <span className="px-3 py-1 bg-green-100 text-green-700 rounded-full text-sm font-medium">Administrative Functions</span>
            <span className="px-3 py-1 bg-orange-100 text-orange-700 rounded-full text-sm font-medium">Comprehensive Programs</span>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-12 border border-gray-100">
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
            ...
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-4 text-center">
              ...
              <p className="text-xs text-purple-600">Service Coverage</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-pink-50 to-pink-100 rounded-xl p-4 text-center">
              ...
              <p className="text-xs text-pink-600">Citizens Served</p>
            </div>
          ...
          <div className="flex flex-col lg:flex-row gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-2 px-4 py-2 bg-indigo-50 rounded-lg">
                ...
                <span className="text-indigo-700 font-medium">{filteredLinks.length} agencies found</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
                ...
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className="flex items-center justify-center relative">
                    <div className="w-16 h-16 bg-gradient-to-br from-indigo-100 to-purple-100 rounded-full shadow-sm border border-indigo-200 overflow-hidden">
                      <img 
                        src={`https://source.unsplash.com/400x400/?${encodeURIComponent(link.name.toLowerCase().replace(/\s+/g, '+'))},logo,official,government`}
                        alt={link.name}
                ...
                <div className="space-y-3 mb-4 mt-auto">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center text-sm">
                      ...
                      <div>
                        <span className="font-semibold text-gray-900">{link.services}</span>
                    ...
                    <div className="px-3 py-1 bg-gradient-to-r from-indigo-100 to-purple-100 text-indigo-700 text-xs rounded-full font-semibold border border-indigo-200">
                      {categories.find(cat => cat.id === link.category)?.name || 'Government'}
                    </div>
                  </div>
          ...
          {filteredLinks.length > 12 && (
            <div className="mt-8 text-center">
              ...
              >
                {showAll ? 'Show Less' : `Show All ${filteredLinks.length} Agencies`}
        ...
        {/* Growth Metric */}
        <div className="mt-8 text-center bg-gradient-to-r from-indigo-50 to-indigo-100 rounded-xl p-6 border border-indigo-100">
