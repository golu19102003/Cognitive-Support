...
import { 
  Users, Heart, MessageCircle, Globe, Shield, Calendar,
  Clock, Star, ExternalLink, Headphones, Phone,
  ChevronRight, CheckCircle, Activity, Award
} from 'lucide-react';
...
const SupportGroups = () => {
  ...
  const supportCategories = [
    { id: 'mental-health', name: 'Mental Health', icon: Heart, color: 'from-blue-500 to-blue-600' },
    { id: 'community', name: 'Community', icon: Users, color: 'from-green-500 to-green-600' },
    { id: 'specialized', name: 'Specialized', icon: Shield, color: 'from-purple-500 to-purple-600' },
    { id: 'online', name: 'Online Forums', icon: Globe, color: 'from-orange-500 to-orange-600' }
  ];
  ...
  const supportResources = [
    {
      ...
      description: 'National Alliance on Mental Illness support groups and education',
      features: ['Peer Support', 'Family Groups', 'Education Programs', 'Local Chapters'],
    ...
    {
      category: 'mental-health',
      name: 'ADAA Support Groups',
      url: 'https://adaa.org/supportgroups',
      description: 'Anxiety and Depression Association of America support communities',
      features: ['Anxiety Support', 'Depression Groups', 'Online Forums', 'Professional Resources'],
      type: 'Mental Health Organization',
      rating: 4.7,
      icon: Users
    },
    {
      ...
      description: 'Real-time anonymous support groups for various mental health challenges',
      features: ['24/7 Support', 'Anonymous Groups', 'Moderated Chats', 'Topic-Based Rooms'],
    ...
    },
    {
      ...
      description: 'Health condition-specific support communities and patient networks',
      features: ['Condition-Specific', 'Patient Stories', 'Expert Moderation', 'Health Resources'],
    ...
    },
    {
      ...
      description: 'Online support groups for various health conditions and life challenges',
    ...
    },
    {
      ...
      features: ['24/7 Listeners', 'Free Support', 'Anonymous Chat', 'Trained Volunteers'],
    ...
    {
      category: 'community',
      name: 'Meetup Mental Health',
      url: 'https://www.meetup.com/topics/mental-health/',
      description: 'Local mental health support groups and meetup events',
      features: ['Local Groups', 'In-Person Meetings', 'Community Events', 'Peer Support'],
    ...
    },
    {
      ...
      name: 'Autism Speaks Support',
      url: 'https://www.autismspeaks.org/support-groups',
      description: 'Support groups for individuals with autism and their families',
      features: ['Autism Support', 'Family Resources', 'Local Chapters', 'Advocacy'],
    ...
    },
    {
      ...
      name: 'CHADD Support',
      url: 'https://chadd.org',
      description: 'Children and Adults with ADHD support groups and resources',
      features: ['ADHD Support', 'Parent Groups', 'Adult ADHD', 'Educational Resources'],
      type: 'ADHD Organization',
      rating: 4.6,
      icon: Users
    },
    {
      ...
      description: 'Mental Health America support groups and screening tools',
      features: ['Screening Tools', 'Support Groups', 'Advocacy', 'Educational Resources'],
      type: 'Mental Health Organization',
      rating: 4.8,
      icon: Heart
    },
    {
      ...
      description: 'UK-based mental illness support groups and services',
      features: ['UK Support', 'Recovery Services', 'Carer Support', 'Helpline'],
    ...
    },
    {
      ...
      description: 'UK mental health charity with local support groups',
      features: ['Local Support', 'Information', 'Helpline', 'Legal Rights'],
      type: 'Mental Health Charity',
      rating: 4.8,
      icon: Heart
    },
    {
      ...
      description: 'Reddit community for mental health discussions and support',
      features: ['Peer Support', 'Anonymous Posting', 'Community Moderation', 'Resource Sharing'],
      type: 'Online Forum',
      rating: 4.4,
      icon: MessageCircle
    },
    {
      ...
      description: 'ADHD support and discussion community on Reddit',
      features: ['ADHD Support', 'Experiences Sharing', 'Tips & Strategies', 'Community Support'],
      type: 'Online Forum',
      rating: 4.5,
      icon: Users
    },
    {
      ...
      description: 'Autism spectrum community for support and discussion',
      features: ['Autism Support', 'Community Discussion', 'Resource Sharing', 'Peer Support'],
      type: 'Online Forum',
      rating: 4.6,
      icon: Globe
    },
    {
      ...
      description: 'Depression and Bipolar Support Alliance peer support groups',
      features: ['Peer Support', 'Wellness Tools', 'Recovery Programs', 'Local Chapters'],
      type: 'Mood Disorder Support',
      rating: 4.7,
      icon: Activity
    },
    {
      category: 'specialized',
      name: 'IOCDF',
      url: 'https://www.iocdf.org',
      description: 'International OCD Foundation support groups and resources',
      features: ['OCD Support', 'Exposure Therapy', 'Professional Directory', 'Research Updates'],
      type: 'OCD Organization',
      rating: 4.8,
      icon: Shield
    },
    {
      ...
      features: ['Helpline', 'Support Groups', 'Treatment Finder', 'Educational Resources'],
  ...
  const handleFormSubmit = (e) => {
    ...
    alert(`Support group request submitted for ${selectedPlatform}! We'll contact you soon.`);
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 py-16">
          <div className="text-center">
            <div className="flex items-center justify-center mb-6">
              ...
              <h1 className="text-4xl font-bold text-white ml-4">Support Groups</h1>
            </div>
            <p className="text-xl text-green-100 max-w-3xl mx-auto mb-8">
              Connect with supportive communities and find understanding peers who share similar experiences
            </p>
            <div className="flex flex-wrap justify-center gap-4 mb-8">
              ...
              <div className="flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full">
                ...
                <span className="text-white font-semibold">Safe & Confidential</span>
              </div>
              <div className="flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8" style={{ gap: isDarkMode ? '1rem' : undefined }}>
          {filteredResources.map((resource, index) => {
            ...
            const categoryColor = supportCategories.find(c => c.id === resource.category)?.color || 'from-green-500 to-green-600';
            return (
              <div
                key={index}
                  ...
                  <div className="flex gap-3">
                    <a
                      ...
                      className={`flex-1 inline-flex flex-col items-center justify-center gap-2 px-4 py-3 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105 ${
                        isDarkMode 
                          ? 'bg-gradient-to-r from-green-700 to-blue-700 text-white hover:from-green-800 hover:to-blue-800 shadow-lg' 
          ...
          <div className="text-center mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              >
                ...
                <div className="font-bold">NAMI HelpLine</div>
                <div className="text-sm">800-950-NAMI</div>
              </a>
            </div>
          </div>
        </div>
            ...
            <div className={`px-8 py-6 border-t ${isDarkMode ? 'border-gray-700' : 'border-gray-200'}`}>
              <div className="flex gap-4">
                ...
                <button
                  ...
                  className="flex-1 px-6 py-3 rounded-xl font-medium text-white bg-gradient-to-r from-green-600 to-blue-600 hover:from-green-700 hover:to-blue-700 transition-all shadow-lg hover:shadow-xl transform hover:scale-105"
                >
