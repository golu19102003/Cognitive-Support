...
import { 
  BookOpen, GraduationCap, Award, Globe, Video, Code,
  Star, ExternalLink, Users, Target, Clock, CheckCircle,
  ChevronRight, Brain, Monitor, Award as Certificate
} from 'lucide-react';
...
const EducationalSupport = () => {
  ...
  const educationCategories = [
    { id: 'global', name: 'Global Platforms', icon: Globe, color: 'from-blue-500 to-blue-600' },
    { id: 'indian', name: 'Indian Platforms', icon: Target, color: 'from-orange-500 to-orange-600' },
    { id: 'coding', name: 'Coding & Tech', icon: Code, color: 'from-green-500 to-green-600' },
    { id: 'academic', name: 'Academic Support', icon: GraduationCap, color: 'from-purple-500 to-purple-600' }
  ];
  ...
  const educationResources = [
    {
      ...
      features: ['Free Courses', 'Math & Science', 'Test Prep', 'Personalized Learning'],
    ...
    },
    {
      ...
      features: ['University Courses', 'Degrees', 'Certificates', 'Flexible Learning'],
    ...
    },
    {
      ...
      features: ['University Partners', 'Free Courses', 'Verified Certificates', 'MicroMasters'],
      type: 'Learning Platform',
      rating: 4.7,
      icon: GraduationCap
    },
    {
      ...
      description: 'Online learning marketplace with various courses',
      features: ['Video Courses', 'Lifetime Access', 'Certificates', 'Wide Variety'],
      type: 'Learning Platform',
      rating: 4.6,
      icon: Video
    },
    {
      ...
      description: 'India\'s largest learning platform for school students',
      features: ['K-12 Education', 'Interactive Learning', 'Live Classes', 'Personalized Programs'],
      type: 'Educational Platform',
      rating: 4.5,
      icon: BookOpen
    },
    {
      ...
      features: ['Exam Prep', 'Live Classes', 'Top Educators', 'Interactive Learning'],
      type: 'Learning Platform',
      rating: 4.6,
      icon: Users
    },
    {
      ...
      description: 'Learning app for school students and competitive exams',
      features: ['School Curriculum', 'Exam Preparation', 'Practice Tests', 'Doubt Resolution'],
      type: 'Educational Platform',
      rating: 4.4,
      icon: Target
    },
    {
      ...
      description: 'Smart learning solutions for K-12 education',
      features: ['Smart Classes', 'Study Material', 'Test Series', 'Parent App'],
      type: 'Educational Platform',
      rating: 4.3,
      icon: Monitor
    },
    {
      category: 'academic',
      name: 'Brainly',
      url: 'https://www.brainly.in',
      description: 'Online learning community for homework help',
      features: ['Homework Help', 'Q&A Platform', 'Expert Solutions', 'Student Community'],
    ...
    },
    {
      ...
      description: 'Online textbook rentals and homework help',
      features: ['Textbook Rental', 'Homework Help', 'Expert Q&A', 'Study Tools'],
    ...
    },
    {
      ...
      description: 'Professional certification courses and training',
      features: ['Professional Courses', 'Certifications', 'Corporate Training', 'Career Support'],
    ...
    },
    {
      ...
      description: 'Higher education and professional development',
      features: ['Higher Education', 'Professional Courses', 'Career Support', 'Industry Partners'],
    ...
    },
    {
      ...
      features: ['Short Courses', 'Degrees', 'Micro-credentials', 'UK Universities'],
      type: 'Learning Platform',
      rating: 4.5,
      icon: Award
    },
    {
      ...
      features: ['Creative Classes', 'Project-Based Learning', 'Community', 'Mobile Access'],
    ...
    },
    {
      ...
      features: ['Interactive Learning', 'Coding Projects', 'Career Paths', 'Pro Plans'],
    ...
    },
    {
      ...
      features: ['Free Courses', 'Certifications', 'Coding Challenges', 'Community Support'],
      type: 'Coding Platform',
      rating: 4.8,
      icon: Code
    },
    {
      ...
      description: 'Computer science portal and coding practice',
      features: ['Coding Practice', 'Interview Prep', 'Articles', 'Contests'],
      type: 'CS Portal',
      rating: 4.7,
      icon: Brain
    },
    {
      ...
      features: ['Web Tutorials', 'References', 'Examples', 'Certifications'],
      type: 'Web Learning',
      rating: 4.5,
      icon: Monitor
    },
    {
      category: 'indian',
      name: 'Testbook',
      url: 'https://www.testbook.com',
      description: 'Exam preparation and mock tests',
      features: ['Mock Tests', 'Live Classes', 'Study Notes', 'Exam Analysis'],
      type: 'Exam Prep',
      rating: 4.4,
      icon: Target
    },
    {
      ...
      description: 'Live online tutoring and test preparation',
      features: ['Live Classes', 'Personal Tutoring', 'Test Series', 'Interactive Learning'],
  ...
  const filteredResources = selectedCategory === 'all' 
    ? educationResources 
    : educationResources.filter(resource => resource.category === selectedCategory);
  ...
  const handleFormSubmit = (e) => {
    ...
    alert(`Educational session request submitted for ${selectedPlatform}! We'll contact you soon.`);
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 py-16">
          <div className="text-center">
            <div className="flex items-center justify-center mb-6">
              ...
              <h1 className="text-4xl font-bold text-white ml-4">Educational Support</h1>
            </div>
            <p className="text-xl text-indigo-100 max-w-3xl mx-auto mb-8">
              Access comprehensive educational resources and learning platforms for academic excellence
            </p>
            <div className="flex flex-wrap justify-center gap-4 mb-8">
              ...
              <div className="flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full">
                ...
                <span className="text-white font-semibold">Certified Courses</span>
              </div>
              <div className="flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full">
                <Clock className="h-5 w-5 text-white" />
                <span className="text-white font-semibold">24/7 Learning</span>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8" style={{ gap: isDarkMode ? '1rem' : undefined }}>
          {filteredResources.map((resource, index) => {
            ...
            const categoryColor = educationCategories.find(c => c.id === resource.category)?.color || 'from-indigo-500 to-indigo-600';
            return (
              <div
                key={index}
        ...
        <div className={`mt-12 p-8 rounded-xl ${isDarkMode ? 'bg-gray-800' : 'bg-white'} shadow-lg`}>
          <div className="text-center mb-6">
            ...
            <p className={`${isDarkMode ? 'text-gray-300' : 'text-gray-600'} mb-6`}>
              Structured learning paths for different educational goals
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className={`p-4 rounded-lg text-center ${
                ...
                <div className="font-bold mb-2">K-12 Students</div>
                <div className="text-sm mb-2">School curriculum support</div>
                <div className="text-xs">BYJU\'S, Toppr, Vedantu</div>
              </div>
              <div className={`p-4 rounded-lg text-center ${
                isDarkMode ? 'bg-green-900/50 text-green-300' : 'bg-green-50 text-green-700'
              }`}>
                <Code className="h-8 w-8 mx-auto mb-2" />
                <div className="font-bold mb-2">Programming</div>
                <div className="text-sm mb-2">Coding and development</div>
                <div className="text-xs">Codecademy, FreeCodeCamp, GfG</div>
              </div>
              <div className={`p-4 rounded-lg text-center ${
                ...
                <div className="text-sm mb-2">University-level courses</div>
                <div className="text-xs">Coursera, edX, UpGrad</div>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="flex-1 overflow-y-auto px-8 py-6">
              <form onSubmit={handleFormSubmit} className="space-y-8">
                ...
                <div>
                  ...
                  <div>
                    <label className={`block text-sm font-medium mb-2 ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>
                      What educational goals do you have? (Optional)
                    </label>
                    <textarea
                      name="concern"
                      ...
                      placeholder="Briefly describe your educational goals..."
                    />
                  </div>
